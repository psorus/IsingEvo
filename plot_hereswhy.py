...
colors=["maroon","red","orange","blue"]
alphas=[1.0,1.0,1.0,1.0]

tasks.append("ising_search")
labels.append("Ising 900")
colors.append("green")
alphas.append(1.0)
...
plt.ylabel("Average Solution Found")
...
plt.savefig("imgs/hereswhy.png",dpi=300,format="png")
plt.savefig("imgs/hereswhy.pdf",format="pdf")
